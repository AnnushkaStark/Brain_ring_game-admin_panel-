...
class Commands(Ui_MainWindow,QMainWindow):
    def __init__(self):
        ...
        self.querry_add_single = '''INSERT INTO single_game (team_name, winners) VALUE (?,?)''' # Этот запрос регистрирует команду в одиноной игре
        self.querry_add_single = '''INSERT INTO tournier (team_name, winners) VALUE (?,?)''' # Этот запрос регистрирует команду в турнире
